...
use App\View\Cell\HolaCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\HolaCell Test Case
 */
class HolaCellTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Hola = new HolaCell($this->request, $this->response);
    }
